  ...
  head: ({ loaderData }) => {
    ...
    return {
      meta: [
        ...
        { title: "Everything PR — PR, Marketing & Social Media News" },
        { name: "description", content: "Everything-PR covers public relations, marketing, social media, and crisis communications news, insights, and agency updates." },
        { property: "og:title", content: "Everything PR — PR, Marketing & Social Media News" },
        { property: "og:type", content: "website" },
        { name: "twitter:card", content: "summary" },
        { name: "twitter:title", content: "Everything PR — PR, Marketing & Social Media News" },
        { property: "og:description", content: "Everything-PR covers public relations, marketing, social media, and crisis communications news, insights, and agency updates." },
        { name: "twitter:description", content: "Everything-PR covers public relations, marketing, social media, and crisis communications news, insights, and agency updates." },
