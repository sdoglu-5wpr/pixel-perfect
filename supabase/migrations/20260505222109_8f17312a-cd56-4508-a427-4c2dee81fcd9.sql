...
begin
  if p_kind = 'category' then
    ...
    select jsonb_build_object('id', id, 'display_name', display_name, 'slug', slug, 'avatar_url', avatar_url, 'bio', bio, 'website', website, 'social', social, 'post_count', post_count, 'kind', 'author')
